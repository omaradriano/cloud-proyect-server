...
export default async function createDocx(template: string, info: Carta_Compromiso) {
    ...
    const content = fs.readFileSync(
        path.resolve(__dirname,'..','templates','prebuilded',`template_${template}.docx`),
        "binary"
        );
    ...
    fs.writeFileSync(path.resolve(__dirname,'..','templates','autogenerated','auto_generated.docx'), buff);
}
